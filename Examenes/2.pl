...
%Se da el caso de que haya 3 mulas en los extremos

%predicados y hechos nuevos
%
%Se modifica en cambiarTurno para que si la variable mula es mayor a 6, se termine el juego
mula3:-
    mula([MulaArr, MulaAb, MulaIz, MulaDe]),
    Cantidad is MulaArr + MulaAb + MulaIz + MulaDe,
    Cantidad > 6,
    write("Hay 3 mulas en los extremos"), nl.
...
asignarFichas:-
    retract(jugador(jugador1,_)), assertz(jugador(jugador1, [[5,5],[6,6],[4,4],[1,1],[0,4]])),
    retract(jugador(jugador2,_)), assertz(jugador(jugador2, [[5,6],[4,5],[1,3],[0,0],[1,5]])),
