...
sumaPuntaje:-
    puntajeGenerado(X),
    X = 3,
    write("Se ha generado puntaje 3 veces"), nl.
...
sumarPuntaje(jugador1):-
    ...
    PuntajeJ1N > PuntajeJ1 -> 
        (X1 is X + 1, retract(puntajeGenerado(_)), assertz(puntajeGenerado(X1))).
