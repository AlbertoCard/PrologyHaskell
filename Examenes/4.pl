...
%en los extremos haya multiplo de 5

%predicados y hechos nuevos

%validar si en todos los extremos hay multiplo de 5
%se usa en cambiarTurno
extremoMulti5:- 
    ...
    0 is Iz mod 5,
    0 is De mod 5,
    write("En los extremos hay multiplo de 5"), nl.

/*
%validar si la suma todos los extremos hay multiplo de 5
extremoMulti5:- 
    extremos([Arr, Ab, Iz, De]),
    0 is (Arr + Ab + Iz + De) mod 5,
    write("En los extremos hay multiplo de 5"), nl.

%validar si en algun extremo hay al menos un multiplo de 5
extremoMulti5:- 
    extremos([Arr, Ab, Iz, De]),
    (
        0 is Arr mod 5
...
asignarFichas:-
    retract(jugador(jugador1,_)), assertz(jugador(jugador1, [[0,6],[0,1],[0,2],[0,3],[0,4]])),
